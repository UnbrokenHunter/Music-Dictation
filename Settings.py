...
def settings(app, root):
    ...
    app.length_var.grid(row=1, column=1, sticky='w')
    ...
    app.key_var.grid(row=1, column=3, sticky='w')
    ...
    app.tempo_var.grid(row=1, column=5, sticky='w')
    ...
    app.scale_type_var.grid(row=3, columnspan=4, padx=5, pady=2)
